...
LONG WINAPI createMiniDump(_EXCEPTION_POINTERS* pep) {
    ...
    auto fnMiniDumpWriteDump =
        (BOOL(WINAPI*)(HANDLE, DWORD, HANDLE, MINIDUMP_TYPE, CONST PMINIDUMP_EXCEPTION_INFORMATION,
    ...
    auto fnSymGetSymFromAddr64 =
        (BOOL(WINAPI*)(HANDLE, DWORD64, PDWORD64, PIMAGEHLP_SYMBOL64))::GetProcAddress(dbghelp, "SymGetSymFromAddr64");
    auto fnSymGetLineFromAddr64 =
        (BOOL(WINAPI*)(HANDLE, DWORD64, PDWORD, PIMAGEHLP_LINE64))::GetProcAddress(dbghelp, "SymGetLineFromAddr64");
    auto fnSymGetModuleInfo64 =
        (BOOL(WINAPI*)(HANDLE, DWORD64, PIMAGEHLP_MODULE64))::GetProcAddress(dbghelp, "SymGetModuleInfo64");
...
#error "Platform not supported!"
    ...
    ::GetLocalTime(&lt);
    snprintf(tempPath, sizeof(tempPath), "crash-%04d%02d%02d-%02d%02d%02d.dmp", lt.wYear, lt.wMonth, lt.wDay, lt.wHour,
...
void tsvitch::initCrashDump() { ::SetUnhandledExceptionFilter(createMiniDump); }

#else

void tsvitch::initCrashDump() {}
